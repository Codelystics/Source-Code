...
@section('content')
    ...
    <style>
        select {
            ...
            background-color: #B000B2; /* Adjust the background color as needed */
        ...
        select::after {
            ...
            color: white; /* Text color of the dropdown arrow */
            pointer-events: none; /* Make sure the arrow does not interfere with the select box */
        }
    </style>
